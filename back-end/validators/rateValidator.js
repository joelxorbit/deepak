...
export const createRateRuleSchema = Joi.object({
  ...
  dateStr: Joi.string().trim().pattern(/^(\d{4}-\d{2}-\d{2}|\d{2}-\d{2}-\d{4})$/).allow('', null).optional(),
  effectiveFrom: Joi.string().trim().pattern(/^(\d{4}-\d{2}-\d{2}|\d{2}-\d{2}-\d{4})$/).allow('', null).optional(),
  effectiveTo: Joi.string().trim().pattern(/^(\d{4}-\d{2}-\d{2}|\d{2}-\d{2}-\d{4})$/).allow('', null).optional(),
