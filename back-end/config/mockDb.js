...
const INITIAL_RATES = [
  {
    id: 'rate_normal_hours',
    _id: 'rate_normal_hours',
    ruleName: 'Price Rule - ₹600 (Normal Hours)',
    sportId: 'all',
    ratePerHour: 600,
    peakRatePerHour: 600,
    weekendRatePerHour: 600,
    daysOfWeek: ['ALL'],
    timeSlots: [
      '10:00 AM - 11:00 AM',
      '11:00 AM - 12:00 PM',
    ...
    status: 'active',
    priority: 20,
    notes: 'Default Normal Hours (10 AM - 4 PM)',
  ...
  },
  {
    id: 'rate_peak_hours',
    _id: 'rate_peak_hours',
    ruleName: 'Price Rule - ₹800 (Peak Hours)',
    sportId: 'all',
    ratePerHour: 800,
    peakRatePerHour: 800,
    ...
    status: 'active',
    priority: 20,
    notes: 'Default Peak Hours (All other times)',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString()
  }
];
